...
На странице эмулируется данный процесс. Параметры n, b, m, t, r вводятся в начальную форму. Далее, после нажатия кнопки "Запустить" на странице выводятся статусы действий. После того, как последний котик будет накормлен, выводится, сколько всего было затрачено времени.
